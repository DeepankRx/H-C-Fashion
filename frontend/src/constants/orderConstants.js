...
export const ORDER_PAID_REQUEST = 'ORDER_DELIVER_REQUEST';
export const ORDER_PAID_SUCCESS = 'ORDER_DELIVER_SUCCESS';
export const ORDER_PAID_FAIL = 'ORDER_DELIVER_FAIL';
export const ORDER_PAID_RESET = 'ORDER_DELIVER_RESET';
